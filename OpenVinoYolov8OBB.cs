...
namespace OpenVinoYOLO
{
    public class OpenVinoYolov8OBB
    {
        ...
        public OpenVinoYolov8OBB(string model_xml_path, bool use_gpu)
        {
        ...
        public List<OBBPrediction> Predict(Mat image, float conf_threshold, float iou_threshold)
        {
            ...
            for (int i = 0; i < objectCount; i++)
            {
                ...
                Span<float> confs = t.AsSpan()[(rowCache + 4)..(rowCache + rowCount - 1)];
